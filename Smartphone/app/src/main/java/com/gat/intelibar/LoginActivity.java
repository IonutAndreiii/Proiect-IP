...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstance) {
        ...
        intentFilter.addAction(Bluetooth.LOGIN_OK);
        intentFilter.addAction(Bluetooth.LOGIN_WRONG);
        ...
        builder.setMessage("Va rugam sa va reintroduceti datele de login!");
    ...
    private class BluetoothBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            else if(action == Bluetooth.LOGIN_OK) {
                openMenuActivity();
                Toast.makeText(context, "Login successful!", Toast.LENGTH_SHORT).show();
            }
            else if(action == Bluetooth.LOGIN_WRONG) {
                builder.show();
            }
        }
    }
